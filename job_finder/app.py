...
#FS.get(MODEL_PATH,'job-finder.h5')
...
def upload_file():
    ...
    for file in files:
        if file and allowed_file(file.filename):
            ...
            FS.put('gcs://data-mlnya/uploads/', filename)
            success = True
            # Ekstrak pdf ke text
            # creating a pdf file object
            pdfFileObj = FS.open('gcs://data-mlnya/uploads/' + filename, 'rb')            
